...
- fix: Buffer named with number opens when committing - fixes [#346](https://github.com/kahole/edamagit/issues/346) (danmilon <i@danmilon.me>)
- fix: Incorrect status shown when rebasing with deleted/renamed files - fixes [#351](https://github.com/kahole/edamagit/issues/351)
...
- fix: Support [] in author name - fixes [#197](https://github.com/kahole/edamagit/issues/197) (George Garside <apps@georgegarside.com>)
- fix: various cases where the log command could skip entries
- fix: Quote currentInstancePath when launching code - fixes [#340](https://github.com/kahole/edamagit/issues/340) (Luke Plant)
...
## [0.6.56]
- adds `git -c diff.noprefix=false` to raw commands (adressing [#276](https://github.com/kahole/edamagit/issues/276))
...
## [0.6.51]
- Make commit and stash detail view update on changes (fixes [#282](https://github.com/kahole/edamagit/issues/282))
